...
/**
 ...
 public class ImageFind {
     ...
     int scrShotImgHeight;             //스크린샷 높이
      ...
      public ImageFind()  {
          ...
          try {
        	...
        	File outputfile = new File(current + File.separator+"img"+File.separator+"full.png");
            ImageIO.write(screenShotImage, "png", outputfile);
            keyImage = ImageIO.read(new File(current + File.separator+"img"+File.separator+"cal_icon.png"));
        } catch (IOException e) {
            e.printStackTrace();
     ...
     public String printFindData() {
    	 ...
    	 String calImgAxis = ""; 
         //System.out.print("##### (X, Y) : ("+this.findImgData[0][0][1]+", "+this.findImgData[0][0][0]+")");
         calImgAxis = this.findImgData[0][0][1] + "," + this.findImgData[0][0][0];
         return calImgAxis;
     }
